...
function CBrif() {
  ...
  useEffect(()=>{
    const fetchOrg = async ()=>{
      const response = await fetch(`http://localhost:4000/orgs/getOneOrg/${user.user.orgId}`)
          ...
          <form action="" className='drpForm' onSubmit={user.user.userType === 'Org'? handleSubmit : handleSubmit2}>
            {user && user.user.userType === "Org" ? (
                ...
                <div className="labDrop">
                    ...
                    <select name="department" id="department" onBlur={(e)=>setDepartment(e.target.value)}>
                ...
                <div className="labDrop">
                    <label>Role</label>
                    <select name="role" id="role" onBlur={(e)=>setRole(e.target.value)}>
                    ...
                    <option value="Human Resource Head4">Human Resource Head4</option>
                    </select>
                </div>
                </>
            ): (
                ...
                <div className="labDrop">
                    <label>Department</label>
                    <select name="" id="" onChange={(e)=>setDepartment2(e.target.value)}>
                ...
                <div className="labDrop">
                    <label>Role</label>
                    <select name="" id="" onChange={(e)=>setRole2(e.target.value)}>
            ...
            {!errorM && errorM!= '' ?(<div className="success">{conf}</div>) : (<div className="errorM">{errorM}</div>) }
          </form>
        </div>
    </div>
  )
